	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Rimozione Account</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Rimozione Account</h1>
			</div>
		</div>
		<!--/.TITOLO-->
		...
		<div class="row">
			<div class="col-lg-12">
				<table class="table table-bordered table-striped">
					...
					<tbody>
					<%
						ArrayList<Utente> lista = (ArrayList<Utente>) request.getAttribute("utentiANDmoderatori");
						for (Utente x : lista) {
					%>
					<tr>
