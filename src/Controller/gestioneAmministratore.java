...
/**
 * Servlet implementation class gestioneAmministratore
 */
...
public class gestioneAmministratore extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//controllo accesso
		if(utente.getTipologia().equals("Utente") || utente.getTipologia().equals("Moderatore")){response.sendRedirect("/oop17/Logout"); return;}
